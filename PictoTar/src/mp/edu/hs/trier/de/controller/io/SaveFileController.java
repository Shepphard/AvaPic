...
public class SaveFileController {
	...
	public void saveAvatarFile(File file) throws Exception {
	    ...
	    for(ShapeModel model : shapeModels)
	    {
		    ...
		    createNode(eventWriter, "shape", model.getShape().toString());
		    createNode(eventWriter, "stroke", model.isStroke()+"");
		    createNode(eventWriter, "fill", model.isFilled()+"");
		    createNode(eventWriter, "strokeColor", model.getStrokeColor().getRGB()+"");
		    createNode(eventWriter, "fillColor", model.getFillColor().getRGB()+"");
		    createNode(eventWriter, "strokeWidth", model.getStrokeWidth()+"");
		    createNode(eventWriter, "sizeX", model.getSizeX()+"");
		    createNode(eventWriter, "sizeY", model.getSizeY()+"");
		    createNode(eventWriter, "maxSizeX", model.getSIZE_X_MAX()+"");
		    createNode(eventWriter, "maxSizeY", model.getSIZE_Y_MAX()+"");
		    createNode(eventWriter, "rotation", model.getRotation()+"");
		    createNode(eventWriter, "centerX", model.getCenterX()+"");
		    createNode(eventWriter, "centerY", model.getCenterY()+"");
