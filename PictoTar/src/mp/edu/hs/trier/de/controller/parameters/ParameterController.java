...
public class ParameterController {
	...
	/**
	 * Sets if the current shape is the one being worked on
	 * @param b Boolean that says true or false
	 */
	...
	/**
	 * Sets the Name of the current shape to be displayed in the Tab
